...
/** CONSTANTS ******************************************************/
/*#define USB_CONFIG_VID 0x07D0
#define USB_CONFIG_PID 0x1781*/

#define USB_CONFIG_VID 0x04D8
#define USB_CONFIG_PID 0x003F
...
ROM USB_DEVICE_DESCRIPTOR device_dsc=
{
    ...
    0x0110,                 // USB Spec Release Number in BCD format 0x0200
    0x00,                   // Class Code
    0x00,                   // Subclass code
    0x00,                   // Protocol code
    USB_EP0_BUFF_SIZE,      // Max packet size for EP0, see usb_config.h
    USB_CONFIG_VID,         // Vendor ID
    USB_CONFIG_PID,         // Product ID: Mouse in a circle fw demo
...
ROM BYTE configDescriptor1[]={
    ...
    0x00,0x01,              // HID Spec Release Number in BCD format (1.11) 0x11,0x01
